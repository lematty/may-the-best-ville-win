...
const globalReducer = createReducer(
  ...
  on(fromActions.addCityToStore, (state, { city, color, averageBuyPrice, averageRentPrice }) => ({
    ...state,
    activeCities: [...state.activeCities, { city, color, averageBuyPrice, averageRentPrice }]
  })),
  on(fromActions.removeCity, (state, { city }) => ({
    ...state,
    activeCities: state.activeCities.filter(activeCity => activeCity.city !== city),
  ...
  on(fromActions.addChartDatasetsToStore, (state, { activeCity, buyChart, rentChart }) => ({ ...state, buyChartDatasets: buyChart, rentChartDatasets: rentChart, lastAddedCity: activeCity })),
